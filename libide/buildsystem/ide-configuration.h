...
void                  ide_configuration_set_parallelism       (IdeConfiguration  *self,
                                                              gint               parallelism);
GFile                *ide_configuration_get_flatpak_manifest  (IdeConfiguration  *self);
void                  ide_configuration_set_flatpak_manifest  (IdeConfiguration  *self,
                                                              GFile             *flatpak_manifest);
GFile                *ide_configuration_get_flatpak_repo_dir  (IdeConfiguration  *self);
void                  ide_configuration_set_flatpak_repo_dir  (IdeConfiguration  *self,
                                                              GFile             *flatpak_repo_dir);
const gchar          *ide_configuration_get_flatpak_repo_name (IdeConfiguration  *self);
void                  ide_configuration_set_flatpak_repo_name (IdeConfiguration  *self,
